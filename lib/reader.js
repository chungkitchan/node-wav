...
Reader.prototype._onSubchunk1 = function (chunk) {
  ...
  this.duration = this.chunkSize / (this.sampleRate * this.channels * (this.bitDepth / 8));    // added ckchan  6 Mar 2020
  var format = {
    ...
    chunkSize: this.chunkSize,  // added by ckchan 6 Mar 2020
    duration: this.duration,    // added by ckchan 6 Mar 2020
    signed: this.signed
  };
